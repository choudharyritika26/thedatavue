...
Route::get('/trainingdetail/{id}', [App\Http\Controllers\frontend\IndexController::class,'trainingdetail'])->name('frontend.trainingdetail');

Route::get('/trainingform', [App\Http\Controllers\frontend\IndexController::class,'trainingform'])->name('frontend.trainingform');
Route::post('/store-trainingform', [App\Http\Controllers\frontend\TrainingformController::class,'store'])->name('store-trainingform');
...
Route::get('/trainingform-index', [App\Http\Controllers\frontend\TrainingformController::class,'index'])->name('trainingform-index');
Route::delete('/delete-trainingform/{id}', [App\Http\Controllers\frontend\TrainingformController::class,'destroy'])->name('destroy-trainingform');

//==========================FooterCopyRight crud=================================
