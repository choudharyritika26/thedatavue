        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Add About Detail</h5>

                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('store-aboutdetail') }}" method="post"
                                ...
                                {{-- <div class="col-12">
                                    ...
                                    <input type="file"
                                        ...
                                        onchange="previewImage(event)" name="image" id="image">
                                    @if ($errors->has('image'))
                                ...
                                <div class="card-action submitAboutdetailBtn">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.submitAboutdetailBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    url: '{{ route('store-aboutdetail', isset($aboutdetail) ? $aboutdetail->id : null) }}',
                    data: formData,
