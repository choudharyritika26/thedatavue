...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        {{-- <h1 style="margin-top: 20px">About Detail Management</h1> --}}

        <span>
            <a href="{{ route('add-aboutdetail') }}"><button class="btn btn-primary">Add About Detail</button></a><br><br>
        </span>
    </div><!-- End Page Title -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table text-center">
                                ...
                                <tbody>
                                    @foreach ($aboutdetail as $index => $item)   
                                    <tr class="sortable-item" data-id="{{ $item->id }}">
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center">
                                                <!-- Edit Button -->
                                                <a href="{{ route('edit-aboutdetail', $item->id) }}"
                                                    class="btn btn-info btn-sm mx-2" title="Edit">
                                                    <i class="fa fa-edit" style="font-size:20px;"></i>
                                                </a>

                                                <form method="POST" action="{{ route('destroy-aboutdetail', $item->id) }}"
    ...
    $(document).ready(function() {
        ...
        $("tbody").sortable({
            ...
            update: function(event, ui) {
                ...
                $.ajax({
                    url: "{{ route('update-aboutdetail-order') }}",  // Define your route here   
                    method: "POST",
                    data: {
                        ids: sortedIDs,
