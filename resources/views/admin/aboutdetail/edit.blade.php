...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <span style="">
                <a href="{{ route('aboutdetail-index') }}"><button class="btn btn-primary">Back</button></a><br><br>
            </span>
            {{-- <span>
                <h1 style="margin-top:-30px; margin-left:800px;"><a href="{{ route('aboutdetail-index') }}">Back</a></h1>
            </span> --}}
            {{-- <nav>
        <ol class="breadcrumb">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit About Detail</h5>


                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('update-aboutdetail', $aboutdetail->id) }}" method="post"
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="heading"
                                        value="{{ $aboutdetail->heading }}"id="heading">
                                </div>

                                <div class="form-group">
                                    <label for="comment">Description</label>
                                    <textarea class="form-control" id="comment" name="description" rows="3">{!! html_entity_decode($aboutdetail->description) !!} </textarea>
                                </div>

                                {{-- <div class="col-12">
                                    <label for="image" class="form-label">Image</label>
                                    <img src="{{ asset('storage/' . $aboutdetail->image) }}" alt="" class="img-fluid mb-3"
                                        style="width: 200px;height:150px;">
                                    <input type="file" class="form-control" name="image" value="{{ $aboutdetail->image }}"
                                ...
                                {{-- <div class="mb-3">
                                    ...
                                    <input class="form-control @error('sort_col') is-invalid @enderror" type="text"
                                        name="sort_col" value="{{ $aboutdetail->sort_col }}" id="sort_col" placeholder="Sort Col"
                                        required />
                                    @error('sort_col')
                                ...
                                <div class="card-action submitEditAboutdetailBtn">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            // Handle the form submission for the aboutdetail
            $('.submitEditAboutdetailBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    type: 'POST',
                    // Adjust the route for the aboutdetail form submission
                    url: '{{ route('update-aboutdetail', $aboutdetail->id) }}',
                    data: formData,
