...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <span style="">
                <a href="{{ route('technology-index') }}"><button class="btn btn-primary">Back</button></a><br><br>
            </span>
            {{-- <span><h1 style="margin-top:-30px; margin-left:800px;"><a href="{{route('technology-index')}}">Back</a></h1></span> --}}
            {{-- <nav>
        <ol class="breadcrumb">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Add Technology</h5>
                            <div class="errorlist">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3 p-4" action="{{ route('store-technology') }}" method="post"
                  ...
                  <input type="text" class="form-control" name="portfolio" id="portfolio"> --}}
                      ...
                      @endif --}}
                                ...
                                <div class="card-action">
                                    <button class="btn btn-success submitTechnologyBtn"
                                        href="{{ route('technology-index') }}">Submit</button>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            // Handle the form submission for the technology
            $('.submitTechnologyBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    type: 'POST',
                    // Adjust the route for the technology form submission
                    url: '{{ route('store-technology', isset($technology) ? $technology->id : null) }}',
                    data: formData,
