...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1 style="margin-top: 20px">Add Faq Heading</h1>
            <span><a href="{{ route('faqheading-index') }}"><button class="btn btn-primary">Back</button></a></span>
            {{-- <nav>
        <ol class="breadcrumb">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('store-faqheading') }}" method="post"
                                ...
                                <div class="card-action">
                                    <button class="btn btn-success submitFaqheadingBtn" type="submit">Submit</button>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.submitFaqheadingBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    url: '{{ route('store-faqheading', isset($faqheading) ? $faqheading->id : null) }}',
                    data: formData,
