...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        {{-- <h1 style="margin-top: 20px">Client Management</h1> --}}
        <span style="">
            <a href="{{ route('add-client') }}"><button class="btn btn-primary">Add</button></a><br><br>
        </span>
    </div><!-- End Page Title -->
                                    ...
                                    <tr class="sortable-item" data-id="{{ $item->id }}">
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <form method="POST" action="{{ route('destroy-client', $item->id) }}"
    ...
    $(document).ready(function() {
        ...
        $("tbody").sortable({
            ...
            update: function(event, ui) {
                ...
                $.ajax({
                    url: "{{ route('update-client-order') }}",  // Define your route here   
                    method: "POST",
                    data: {
                        ids: sortedIDs,
