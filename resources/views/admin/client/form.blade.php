...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            {{-- <span><h1 style="margin-top:-30px; margin-left:800px;"><a href="{{route('client-index')}}">Back</a></h1></span> --}}
            <span style="">
                <a href="{{ route('client-index') }}"><button class="btn btn-primary">Back</button></a><br><br>
            </span>
            {{-- <nav>
        <ol class="breadcrumb">
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3" action="{{ route('store-client') }}" method="post"
                                ...
                                <div class="card-action">
                                    <button class="btn btn-success submitClientBtn" type="submit">Submit</button>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            // Handle the form submission for the client
            $('.submitClientBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    type: 'POST',
                    // Adjust the route for the client form submission
                    url: '{{ route('store-client', isset($client) ? $client->id : null) }}',
                    data: formData,
