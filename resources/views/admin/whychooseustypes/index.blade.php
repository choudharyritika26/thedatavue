...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        {{-- <h1 style="margin-top: 20px">Why Choose Us Types Management</h1> --}}
        <span>
            {{-- @if ($whychooseustypes->isEmpty()) --}}
                <a href="{{ route('add-whychooseustypes') }}"><button class="btn btn-primary">Add</button></a>
            {{-- @endif --}}
        </span>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Why Choose Us Types</h5>
                        ...
                        <div class="table-responsive">
                            <table class="table text-center">
                                ...
                                <tbody>
                                    @foreach ($whychooseustypes as $index => $item)
                                    <tr class="sortable-item" data-id="{{ $item->id }}">
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center">
                                                <!-- Edit Button -->
                                                <a href="{{ route('edit-whychooseustypes', $item->id) }}"
                                                    class="btn btn-info btn-sm mx-2" title="Edit">
                                                    <i class="fa fa-edit" style="font-size:20px;"></i>
                                                </a>

                                                <form method="POST" action="{{ route('destroy-whychooseustypes', $item->id) }}"
    ...
    $(document).ready(function() {
        ...
        $("tbody").sortable({
            ...
            update: function(event, ui) {
                ...
                $.ajax({
                    url: "{{ route('update-whychooseustypes-order') }}",  // Define your route here   
                    method: "POST",
                    data: {
                        ids: sortedIDs,
