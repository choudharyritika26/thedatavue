        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit Why Choose Us Type</h5>

                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('update-whychooseustypes',$whychooseustypes->id) }}" method="post"
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="heading"
                                        value="{{ $whychooseustypes->heading }}"id="heading">
                                </div>

                                <div class="form-group">
                                    <label for="comment">Description</label>
                                    <textarea class="form-control" id="comment" name="description" rows="3">{!! html_entity_decode($whychooseustypes->description) !!} </textarea>
                                ...
                                {{-- <div class="col-12">
                                    ...
                                    <img src="{{ asset('storage/' . $whychooseustypes->image) }}" alt="" class="img-fluid mb-3"
                                        style="width: 200px;height:150px;">
                                    <input type="file" class="form-control" name="image" value="{{ $whychooseustypes->image }}"
                                        id="image">
                                </div> --}}
                                ...
                                {{-- <div class="mb-3">
                                    ...
                                    <input class="form-control @error('sort_col') is-invalid @enderror" type="text"
                                        name="sort_col" value="{{ $whychooseustypes->sort_col }}" id="sort_col" placeholder="Sort Col" required/>
                                    @error('sort_col')
                                ...
                                <div class="card-action submitEditWhychooseustypesBtn">
                                    <button class="btn btn-success" href="{{ route('whychooseustypes-index') }}">Submit</button>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.submitEditWhychooseustypesBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    url: '{{ route('update-whychooseustypes', $whychooseustypes->id) }}',
                    data: formData,
