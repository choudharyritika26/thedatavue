...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            {{-- <span>
                <h1 style="margin-top:-30px; margin-left:800px;"><a href="{{ route('servicesdetails-index') }}">Back</a></h1>
            </span> --}}
            <span style="">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit Services Details </h5>
                            

                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('update-servicesdetails', $servicesdetails->id) }}"
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-select" name="service" id="catagory">
                                        <option value="">Select Service</option>
                                        @foreach ($servicescatagries as $item)    
                                            <option value="{{ $item->id }}"
                                                {{ old('item', $servicesdetails->service ?? '') == $item->id ? 'selected' : '' }}>
                                                {{ $item->heading }}    
                                            </option>
                                        @endforeach
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="heading"
                                        value="{{ $servicesdetails->heading }}"id="heading">
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" id="comment" name="description" rows="3">{{ $servicesdetails->description }} </textarea>
                                </div>
                                {{-- <div class="col-12">
                                    <label for="sort">Sort Col</label>
                                    <input class="form-control @error('sort_col') is-invalid @enderror" type="text"
                                        name="sort_col" value="{{ $servicesdetails->sort_col }}" id="sort_col" placeholder="Sort Col" required/>
                                    @error('sort_col')
                                ...
                                <div class="card-action submitEditServicesdetailesBtn">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.submitEditServicesdetailesBtn').click(function(e) {
                // alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    url: '{{ route('update-servicesdetails', $servicesdetails->id) }}',
                    data: formData,
