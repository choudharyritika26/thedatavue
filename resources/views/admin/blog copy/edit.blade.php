...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <span style="">
                <a href="{{ route('blog-index') }}"><button class="btn btn-primary">Back</button></a><br><br>
            </span>
            {{-- <span>
                <h1 style="margin-top:-30px; margin-left:800px;"><a href="{{ route('blog-index') }}">Back</a></h1>
            </span> --}}
            {{-- <nav>
        <ol class="breadcrumb">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <h5 class="card-title">Edit Blog</h5>
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('update-blog', $blog->id) }}" method="post"
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="name"
                                        value="{{ $blog->name }}"id="name">
                                </div>

                                <div class="col-12">
                                    <label for="heading" class="form-label">Heading</label>
                                    <input type="text" class="form-control" name="heading"
                                        value="{{ $blog->heading }}"id="heading">
                                </div>

                                <div class="col-12">
                                    <label for="comment">Description</label>
                                    <textarea class="form-control" id="comment" name="description" rows="3">{!! html_entity_decode($blog->description) !!} </textarea>
                                </div>

                                <div class="col-12">

                                    <label for="image" class="form-label">Image</label>
                                    <img src="{{ asset('storage/' . $blog->image) }}" alt="" class="img-fluid mb-3"
                                ...
                                {{-- <div class="col-12">
                                    ...
                                    <input class="form-control @error('sort_col') is-invalid @enderror" type="text"
                                        name="sort_col" value="{{ $blog->sort_col }}" id="sort_col" placeholder="Sort Col" required/>
                                    @error('sort_col')
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            // Handle the form submission for the blog
            $('.submitEditBlogBtn').click(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    // Adjust the route for the blog form submission
