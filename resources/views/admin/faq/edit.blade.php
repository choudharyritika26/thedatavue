                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('update-faq', $faq->id) }}" method="post"
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="question"
                                        value="{{ $faq->question }}"id="question">
                                </div>

                                <div class="col-12">
                                    <label for="comment">Answer</label>
                                    <textarea class="form-control" id="comment" name="answer" rows="3">{!! html_entity_decode($faq->answer) !!} </textarea>
                                ...
                                {{-- <div class="col-12">
                                    ...
                                    <img src="{{ asset('storage/' . $faq->image) }}" alt="" class="img-fluid mb-3"
                                        style="width: 200px;height:150px;">
                                    <input type="file" class="form-control" name="image" value="{{ $faq->image }}"
                                        id="image">
                                </div> --}}
                                {{-- <div class="col-12">
                                    <label for="sort">Sort Col</label>
                                    <input class="form-control @error('sort_col') is-invalid @enderror" type="text"
                                        name="sort_col" value="{{ $faq->sort_col }}" id="sort_col" placeholder="Sort Col" required/>
                                    @error('sort_col')
                                ...
                                <div class="card-action">
                                    <button class="btn btn-success submitEditFaqBtn" type="submit">Submit</button>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.submitEditFaqBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                const answer = editorInstance.getData(); // Use the global editor instance
                formData.set('answer', answer); // Set the description field with CKEditor data
