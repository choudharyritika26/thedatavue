...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        {{-- <h1 style="margin-top: 20px">FAQ Management</h1> --}}
        <span>
            {{-- @if ($faq->isEmpty()) --}}
                <a href="{{ route('add-faq') }}"><button class="btn btn-primary">Add</button></a>
            {{-- @endif --}}
        </span>
    </div><!-- End Page Title -->
                                    ...
                                    <tr class="sortable-item" data-id="{{ $item->id }}">
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <form method="POST" action="{{ route('destroy-faq', $item->id) }}"
    ...
    $(document).ready(function() {
        ...
        $("tbody").sortable({
            ...
            update: function(event, ui) {
                ...
                $.ajax({
                    url: "{{ route('update-faq-order') }}",  // Define your route here   
                    method: "POST",
                    data: {
                        ids: sortedIDs,
