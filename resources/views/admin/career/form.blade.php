...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            {{-- <span><h1 style="margin-top:-30px; margin-left:800px;"><a href="{{route('career-index')}}">Back</a></h1></span> --}}
            <span style="">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('store-career') }}" method="post"
                                ...
                                <div class="card-action">
                                    <button class="btn btn-success submitCareerBtn"
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.submitCareerBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
        ...
        formData.set('description', description); // Set the description field with CKEditor data
                ...
                $.ajax({
                    ...
                    url: '{{ route('store-career', isset($career) ? $career->id : null) }}',
                    data: formData,
