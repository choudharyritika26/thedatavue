...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            {{-- <span>
                <h1 style="margin-top:-30px; margin-left:800px;"><a href="{{ route('career-index') }}">Back</a></h1>
            </span> --}}
            <span style="">
                <a href="{{ route('career-index') }}"><button class="btn btn-primary">Back</button></a><br><br>
            </span>
            {{-- <nav>
        <ol class="breadcrumb">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('update-career',$career->id) }}" method="post"
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="heading"
                                        value="{{ $career->heading }}"id="heading">
                                </div>

                                <div class="col-12">
                                    <label for="exp" class="form-label">Experience</label>
                                    <input type="text" class="form-control" name="exp"
                                        value="{{ $career->exp }}"id="exp">
                                </div>

                                <div class="form-group">
                                    <label for="comment">Description</label>
                                    <textarea class="form-control" id="comment" name="description" rows="3">{{ $career->description }} </textarea>
                                ...
                                {{-- <div class="col-12">
                                    ...
                                    <img src="{{ asset('storage/' . $career->image) }}" alt="" class="img-fluid mb-3"
                                        style="width: 200px;height:150px;">
                                    <input type="file" class="form-control" name="image" value="{{ $career->image }}"
                                        id="image">
                                </div> --}}
                                {{-- <div class="col-12">
                                    <label for="sort">Sort Col</label>
                                    <input class="form-control @error('sort_col') is-invalid @enderror" type="text"
                                        name="sort_col" value="{{ $career->sort_col }}" id="sort_col" placeholder="Sort Col" required/>
                                    @error('sort_col')
                                ...
                                <div class="card-action submitEditClientBtn">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.submitEditClientBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
        ...
        formData.set('description', description); // Set the description field with CKEditor data
                ...
                $.ajax({
                    ...
                    url: '{{ route('update-career', $career->id) }}',
                    data: formData,
