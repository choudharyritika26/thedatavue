...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('career-index') ? 'active' : '' }}"
        ...
        {{-- <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('contactus-index') ? 'active' : '' }} "
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('qualification-index', 'trainingtype-index') ? 'active' : 'collapsed' }}"
            ...
            <ul id="tables-nav"
                class="nav-content collapse {{ request()->routeIs('qualification-index', 'trainingtype-index') ? 'show' : '' }}"
                data-bs-parent="#sidebar-nav">

                <li>
                    <a href="{{ route('trainingtype-index') }}"
                        class="{{ request()->routeIs('trainingtype-index') ? 'active' : '' }}">
                ...
                <li>
                    <a href="{{ route('qualification-index') }}"
                        class="{{ request()->routeIs('qualification-index') ? 'active' : '' }}">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('footer-copy-right-index', 'contactus-index') ? 'active' : 'collapsed' }}" 
                data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-gem"></i>
                <span>Footer</span>
                <i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="icons-nav" class="nav-content collapse {{ request()->routeIs('footer-copy-right-index', 'contactus-index') ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('footer-copy-right-index') }}" class="{{ request()->routeIs('footer-copy-right-index') ? 'active' : '' }}">
                        <i class="bi bi-circle"></i><span>Footer Copy Right</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('contactus-index') }}" class="{{ request()->routeIs('contactus-index') ? 'active' : '' }}">
                        <i class="bi bi-circle"></i><span>Contact Us Footer</span>
                    </a>
                </li>
            </ul>
        </li>
        ...
        <li class="nav-item">
            ...
            <ul id="icons-nav"
                class="nav-content collapse {{ request()->routeIs('whychooseus-index', 'whychooseustypes-index') ? 'show' : '' }}"
                data-bs-parent="#sidebar-nav">
                <li>
                    <a href="{{ route('whychooseus-index') }}"
                        class="{{ request()->routeIs('whychooseus-index') ? 'active' : '' }}">
                        <i class="bi bi-circle"></i><span>Why Choose Us Heading</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('whychooseustypes-index') }}"
                        class="{{ request()->routeIs('whychooseustypes-index') ? 'active' : '' }}">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('careercontact-index') ? 'active' : '' }} "
                href="{{ route('careercontact-index') }}">
                <i class="bi bi-menu-button-wide"></i>
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('enquiry-index') ? 'active' : '' }} "
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('trainingform-index') ? 'active' : '' }} "
                href="{{ route('trainingform-index') }}">
                <i class="bi bi-menu-button-wide"></i>
