...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            {{-- <h1 style="margin-top: 20px">qualification Management</h1> --}}
            <span>
                <a href="{{ route('add-qualification') }}"><button class="btn btn-primary">Add
                        Qualification</button></a><br><br>
            </span>
        </div><!-- End Page Title -->
                                            ...
                                            <tr class="sortable-item" data-id="{{ $item->id }}">
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex justify-content-center">
                                                        <!-- Edit Button -->
                                                        <a href="{{ route('edit-qualification', $item->id) }}"
                                                            class="btn btn-info btn-sm mx-2" title="Edit">
                                                            <i class="fa fa-edit" style="font-size:20px;"></i>
                                                        </a>

                                                        <form method="POST"
                                                            action="{{ route('destroy-qualification', $item->id) }}"
        ...
        $(document).ready(function() {
            ...
            $("tbody").sortable({
                ...
                update: function(event, ui) {
                    ...
                    $.ajax({
                        url: "{{ route('update-qualification-order') }}", // Define your route here   
                        method: "POST",
                        data: {
                            ids: sortedIDs,
