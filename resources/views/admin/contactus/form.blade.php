        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Add Contact Us Footer</h5>
                            

                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('store-contactus') }}" method="post"
                                ...
                                <div class="col-12">
                                    <label for="phone" class="form-label">Phone No.</label>
                                    <input type="tel" class="form-control" name="phone_no" id="phone" pattern="^[0-9]{10}$" maxlength="10" oninput="validatePhone()" required>
                                    @if ($errors->has('phone'))
                                        <span class="text-danger">{{ $errors->first('phone') }}</span>
                                    @endif
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="file" class="image-input form-control @error('image') is-invalid @enderror"
                                ...
                                <div class="card-action submitContactusBtn">
...
<script>
    $(document).ready(function() {
        ...
        $('.submitContactusBtn').click(function(e) {
            //alert('jijed');
            e.preventDefault();
            ...
            $.ajax({
                type: 'POST',
                // Adjust the route for the contactus form submission
                url: '{{ route('store-contactus', isset($contactus) ? $contactus->id : null) }}',
                data: formData,
