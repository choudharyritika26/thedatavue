...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <span><a href="{{ route('whychooseus-index') }}"><button class="btn btn-primary">Back</button></a></span>
            {{-- <nav>
        <ol class="breadcrumb">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Add Why Choose Us Heading </h5>


                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('store-whychooseus') }}" method="post"
                                ...
                                <div class="card-action">
                                    <button class="btn btn-success submitWhychooseusBtn"
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.submitWhychooseusBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    url: '{{ route('store-whychooseus', isset($whychooseus) ? $whychooseus->id : null) }}',
                    data: formData,
