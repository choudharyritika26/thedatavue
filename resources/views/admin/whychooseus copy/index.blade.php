    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            @if ($whychooseus->isEmpty())
                <a href="{{ route('add-whychooseus') }}"><button class="btn btn-primary">Add</button></a>
                @endif
            </span>
            {{-- <nav>
        <ol class="breadcrumb">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title"> Why Choose Us Heading </h5>
                                ...
                                <tbody>
                                    @foreach ($whychooseus as $index => $item)
                                        {{-- <tr>
                                            ...
                                            {{-- <td>
                                                <a href="{{ route('edit-whychooseus', $item->id) }}"> <i class="fa fa-edit"
                                                        style="font-size:30px"></i></a>
                                                <br>
                                            
                                                <form action="{{ route('destroy-whychooseus', $item->id) }}" method="post">
                                                    @method('DELETE')
                                                    @csrf
                                                    @method('delete')
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex justify-content-center">
                                                    <!-- Edit Button -->
                                                    <a href="{{ route('edit-whychooseus', $item->id) }}"
                                                        class="btn btn-info btn-sm mx-2" title="Edit">
                                                        <i class="fa fa-edit" style="font-size:20px;"></i>
                                                    </a>

                                                    <form method="POST" action="{{ route('destroy-whychooseus', $item->id) }}"
