...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <span>
                <a href="{{ route('whychooseus-index') }}"><button class="btn btn-primary">Back</button></a>
            </span>
            {{-- <nav>
        <ol class="breadcrumb">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit Why Choose Us</h5>
                            

                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('update-whychooseus',$whychooseus->id) }}" method="post"
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="heading"
                                        value="{{ $whychooseus->heading }}"id="heading">
                                </div>

                                <div class="col-12">
                                    <label for="comment">Description</label>
                                    <textarea class="form-control" id="comment" name="description" rows="3">{!! html_entity_decode($whychooseus->description) !!} </textarea>
...
{{-- 
                                ...
                                <div class="col-12">
                                    ...
                                    <img src="{{ asset('storage/' . $whychooseus->image) }}" alt="" class="img-fluid mb-3"
                                        style="width: 200px;height:150px;">
                                    <input type="file" class="form-control" name="image" value="{{ $whychooseus->image }}"
                                ...
                                <!-- <div class="col-12">
                                    ...
                                    <input class="form-control @error('sort_col') is-invalid @enderror" type="text"
                                        name="sort_col" value="{{ $whychooseus->sort_col }}" id="sort_col" placeholder="Sort Col" required/>
                                    @error('sort_col')
                                ...
                                <div class="card-action submitEditWhychooseusBtn">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            // Handle the form submission for the whychooseus
            $('.submitEditWhychooseusBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    type: 'POST',
                    // Adjust the route for the whychooseus form submission
                    url: '{{ route('update-whychooseus', $whychooseus->id) }}',
                    data: formData,
