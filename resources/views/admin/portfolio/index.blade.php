...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1 style="margin-top: 20px">Portfolio Tables</h1>
            <span>
                                ...
                                <tbody>
                                    @foreach ($portfolio as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit-portfolio', $item->id) }}"> <i class="fa fa-edit"
                                                        style="font-size:30px"></i></a>
                                                <br>
                                                {{-- <a href="{{ route('delete-portfolio', $item->id) }}" 
                                    class="btn btn-danger btn-sm">Delete</a> --}}
                                                {{-- <a href="{{ route('destroy-portfolio', $item->id) }}"> <i
                                        class="fa fa-trash-o" style="font-size:30px"></i>
                                        
                                    </a> --}}
                                                <form action="{{ route('destroy-portfolio', $item->id) }}" method="post">
                                                    @method('DELETE')
                                                    @csrf
                                                    @method('delete')
