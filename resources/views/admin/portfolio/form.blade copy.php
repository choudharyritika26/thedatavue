            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="row g-3" action="{{ route('store-portfolio') }}" method="post"
                        ...
                        {{-- <div class="col-12">
                            <label for="enddate" class="form-label">Project URL</label>
                        ...
                        {{-- <div class="col-12">
                            ...
                            <input type="url" class="form-control" name="project_url" id="project_url" value="{{ old('project_url') }}" required>
                        ...
                        <div class="col-12">
                            ...
                            <input type="file" name="slider_image[]" multiple id="slider_image" accept="image/*" class="image-input form-control @error('slider_image') is-invalid @enderror" onchange="previewSlidersImages(event)">
                        ...
                        <div class="slider-image-preview-container" style="display: none;">
                            ...
                            <input type="hidden" class="slider-crop-data-x" name="sliderCropDataX">
                            <input type="hidden" class="slider-crop-data-y" name="sliderCropDataY">
                            <input type="hidden" class="slider-crop-data-width" name="sliderCropDataWidth">
                            <input type="hidden" class="slider-crop-data-height" name="sliderCropDataHeight">
                        </div>
...
@section('script')
    ...
    if (files.length > 0) {
        ...
        reader.onload = function(e) {
            ...
            document.querySelector('.slider-image-preview-container').style.display = 'block'; // Updated class name
            ...
            sliderCropper = new Cropper(imagePreview, {
                ...
                viewMode: 1,
                crop(event) {
                    document.querySelector('input[name="sliderCropDataX"]').value = Math.round(event.detail.x);
                    document.querySelector('input[name="sliderCropDataY"]').value = Math.round(event.detail.y);
                    document.querySelector('input[name="sliderCropDataWidth"]').value = Math.round(event.detail.width);
                    document.querySelector('input[name="sliderCropDataHeight"]').value = Math.round(event.detail.height);
                },
            });
        };
