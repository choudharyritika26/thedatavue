...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        {{-- <h1 style="margin-top: 20px">Services Management</h1> --}}
        <span>
            {{-- @if ($services->isEmpty()) --}}
                <a href="{{ route('add-services') }}"><button class="btn btn-primary">Add</button></a>
            {{-- @endif --}}
        </span>
    </div><!-- End Page Title -->
    ...
    $(document).ready(function() {
        ...
        $("tbody").sortable({
            ...
            update: function(event, ui) {
                ...
                $.ajax({
                    url: "{{ route('update-services-order') }}",  // Define your route here   
                    method: "POST",
                    data: {
                        ids: sortedIDs,
