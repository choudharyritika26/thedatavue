        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body ">
                            <h5 class="card-title">Edit Services Category</h5>

                            

                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('update-servicescatagries',$servicescatagries->id) }}" method="post"
                                ...
                                <div class="col-12 ">
                                    <label for="servicescatagries" class="form-label">Category</label>
                                    <input type="text" class="form-control" name="category"   
                                        value="{{ $servicescatagries->category }}">
                                </div>
                                <div class="col-12">
                                    <label for="sort">Sort Col</label>
                                    <input class="form-control @error('sort_col') is-invalid @enderror" type="text"
                                        name="sort_col" value="{{ $servicescatagries->sort_col }}" id="sort_col" placeholder="Sort Col" required/>
                                    @error('sort_col')
                                ...
                                <div class="card-action submitEditServicescatagriesBtn">
...
$(document).ready(function() {
    ...
    $('.submitEditServicescatagriesBtn').click(function(e) {
        e.preventDefault();
        ...
        $.ajax({
            type: 'POST',
            url: '{{ route('update-servicescatagries', $servicescatagries->id) }}',
            data: formData,
