...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <span style="">
                <a href="{{ route('servicescatagries-index') }}"><button class="btn btn-primary">Back</button></a><br><br>
            </span>
            {{-- <span><h1 style="margin-top:-30px; margin-left:800px;"><a href="{{route('servicescatagries-index')}}">Back</a></h1></span> --}}
            {{-- <nav>
        <ol class="breadcrumb">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Add Services Category</h5>
                            

                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('store-servicescatagries') }}" method="post"
                                ...
                                <div class="col-12">
                                    <label for="servicescatagries" class="form-label">Catagries</label>
                                ...
                                <div class="card-action submitServicescatagriesBtn">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            // Handle the form submission for the servicescatagries
            $('.submitServicescatagriesBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    type: 'POST',
                    // Adjust the route for the servicescatagries form submission
                    url: '{{ route('store-servicescatagries', isset($servicescatagries) ? $servicescatagries->id : null) }}',
                    data: formData,
