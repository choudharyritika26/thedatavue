...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            {{-- <span><h1 style="margin-top:-30px; margin-left:800px;"><a href="{{route('trainingtype-index')}}">Back</a></h1></span> --}}
            {{-- <nav>
        <ol class="breadcrumb">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Add Training Type</h5>

                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('store-trainingtype') }}" method="post"
                                ...
                                <div class="card-action submitTrainingtypeBtn">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.submitTrainingtypeBtn').click(function(e) {
                // alert('jijed');
                e.preventDefault();
