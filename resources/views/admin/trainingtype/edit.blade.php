...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <span style="">
                <a href="{{ route('trainingtype-index') }}"><button class="btn btn-primary">Back</button></a><br><br>
            </span>
            {{-- <span>
                <h1 style="margin-top:-30px; margin-left:800px;"><a href="{{ route('trainingtype-index') }}">Back</a></h1>
            </span> --}}
            {{-- <nav>
        <ol class="breadcrumb">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit Training Type</h5>

                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('update-trainingtype',$trainingtype->id) }}" method="post"
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="heading"
                                        value="{{ $trainingtype->heading }}"id="heading">
                                </div>

                                <div class="col-12">
                                    <label for="comment">Description</label>
                                    <textarea class="form-control" name="description" id="comment"
                                     rows="3">{{ $trainingtype->description }} </textarea> 
                                </div>

                                <div class="col-12">
                                    <label for="duration" class="form-label">Duration</label>
                                    <input type="text" class="form-control" name="duration"
                                        value="{{ $trainingtype->duration }}"id="duration">
                                </div>

                                <div class="col-12">

                                    <label for="image" class="form-label">Image</label>
                                    <img src="{{ asset('storage/' . $trainingtype->image) }}" alt="" class="img-fluid mb-3"
                                        style="width: 200px;height:150px;">
                                    <input type="file" class="form-control" name="image" value="{{ $trainingtype->image }}"
                                ...
                                {{-- <div class="col-12">
                                    ...
                                    <input class="form-control @error('sort_col') is-invalid @enderror" type="text"
                                        name="sort_col" value="{{ $trainingtype->sort_col }}" id="sort_col" placeholder="Sort Col" required/>
                                    @error('sort_col')
                                ...
                                <div class="card-action">
                                    <button class="btn btn-success submitEditTrainingtypeBtn" type="submit">Submit</button>
...
$(document).ready(function() {
    // Handle the form submission for the trainingtype
    $('.submitEditTrainingtypeBtn').click(function(e) {
        e.preventDefault();
        ...
        $.ajax({
            type: 'POST',
            url: '{{ route('update-trainingtype', $trainingtype->id) }}',
            data: formData,
    ...
    {{-- <script>
        $(document).ready(function() {
            ...
            $('.submitEditSliderBtn').click(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    // Adjust the route for the trainingtype form submission
                    url: '{{ route('update-trainingtype', $trainingtype->id) }}',
                    data: formData,
                    contentType: false, // Important: Set this to false to send the file
                    processData: false, // Important: Set this to false to send the file
