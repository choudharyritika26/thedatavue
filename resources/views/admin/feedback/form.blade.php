                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('store-feedback') }}" method="post"
                                ...
                                <div class="card-action submitFeedbackBtn">
        ...
        $(document).ready(function() {
            ...
            $('.submitFeedbackBtn').click(function(e) {
                ...
                $.ajax({
                    ...
                    url: '{{ route('store-feedback', isset($feedback) ? $feedback->id : null) }}',
                    data: formData,
