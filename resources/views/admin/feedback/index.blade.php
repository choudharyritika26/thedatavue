...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        {{-- <h1 style="margin-top: 20px">Feedback Management</h1> --}}
        <span>
            {{-- @if ($feedback->isEmpty()) --}}
                <a href="{{ route('add-feedback') }}"><button class="btn btn-primary">Add</button></a>
            {{-- @endif --}}
        </span>
    </div><!-- End Page Title -->
                                    ...
                                    <tr class="sortable-item" data-id="{{ $item->id }}">
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center">
                                                <!-- Edit Button -->
                                                <a href="{{ route('edit-feedback', $item->id) }}"
                                                    class="btn btn-info btn-sm mx-2" title="Edit">
                                                    <i class="fa fa-edit" style="font-size:20px;"></i>
                                                </a>

                                                <form method="POST" action="{{ route('destroy-feedback', $item->id) }}"
    ...
    $(document).ready(function() {
        ...
        $("tbody").sortable({
            ...
            update: function(event, ui) {
                ...
                $.ajax({
                    url: "{{ route('update-feedback-order') }}",  // Define your route here   
                    method: "POST",
                    data: {
                        ids: sortedIDs,
