        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Add Training Headingx</h5>

                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('store-training') }}" method="post"
                                ...
                                <div class="card-action submitTrainingBtn">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.submitTrainingBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    url: '{{ route('store-training', isset($training) ? $training->id : null) }}',
                    data: formData,
