        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Add Language Detail</h5>

                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('store-percentage') }}" method="post"
                                ...
                                <div class="card-action submitPercentageBtn">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.submitPercentageBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    url: '{{ route('store-percentage', isset($percentage) ? $percentage->id : null) }}',
                    data: formData,
