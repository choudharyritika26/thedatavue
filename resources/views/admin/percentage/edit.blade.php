...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <span style="">
                <a href="{{ route('percentage-index') }}"><button class="btn btn-primary">Back</button></a><br><br>
            </span>
            {{-- <span>
                <h1 style="margin-top:-30px; margin-left:800px;"><a href="{{ route('percentage-index') }}">Back</a></h1>
            </span> --}}
            {{-- <nav>
        <ol class="breadcrumb">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit Language Detail</h5>


                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('update-percentage', $percentage->id) }}" method="post"
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="language"
                                        value="{{ $percentage->language }}"id="language">
                                </div>

                                <div class="col-12">
                                    <label for="percent" class="form-label">Percentage</label>
                                    <input type="text" class="form-control" name="percent"
                                        value="{{ $percentage->percent }}"id="percent">
                                </div>

                                {{-- <div class="form-group">
                                    <label for="comment">Description</label>
                                    <textarea class="form-control" id="comment" name="description" rows="3">{!! html_entity_decode($percentage->description) !!} </textarea>
                                </div> --}}

                                {{-- <div class="col-12">
                                    <label for="image" class="form-label">Image</label>
                                    <img src="{{ asset('storage/' . $percentage->image) }}" alt="" class="img-fluid mb-3"
                                        style="width: 200px;height:150px;">
                                    <input type="file" class="form-control" name="image" value="{{ $percentage->image }}"
                                ...
                                {{-- <div class="mb-3">
                                    ...
                                    <input class="form-control @error('sort_col') is-invalid @enderror" type="text"
                                        name="sort_col" value="{{ $percentage->sort_col }}" id="sort_col" placeholder="Sort Col"
                                        required />
                                    @error('sort_col')
                                ...
                                <div class="card-action submitEditPercentageBtn">
 ...
 --}}
    ...
    <script>
        $(document).ready(function() {
            // Handle the form submission for the percentage
            $('.submitEditPercentageBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    type: 'POST',
                    // Adjust the route for the percentage form submission
                    url: '{{ route('update-percentage', $percentage->id) }}',
                    data: formData,
