...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <span style="">
                <a href="{{ route('project-index') }}"><button class="btn btn-primary">Back</button></a><br><br>
            </span>
            {{-- <span>
                <h1 style="margin-top:-30px; margin-left:800px;"><a href="{{ route('project-index') }}">Back</a></h1>
            </span> --}}
            {{-- <nav>
        <ol class="breadcrumb">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('update-project', $project->id) }}" method="post"
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="project"
                                        value="{{ $project->project }}"id="project">
                                </div>

                                <div class="col-12">
                                    <label for="count" class="form-label">Count</label>
                                    <input type="text" class="form-control" name="count"
                                        value="{{ $project->count }}"id="count">
                                </div>

                                {{-- <div class="form-group">
                                    <label for="comment">Description</label>
                                    <textarea class="form-control" id="comment" name="description" rows="3">{!! html_entity_decode($project->description) !!} </textarea>
                                </div> --}}

                                {{-- <div class="col-12">
                                    <label for="image" class="form-label">Image</label>
                                    <img src="{{ asset('storage/' . $project->image) }}" alt="" class="img-fluid mb-3"
                                ...
                                {{-- <div class="mb-3">
                                    ...
                                    <input class="form-control @error('sort_col') is-invalid @enderror" type="text"
                                        name="sort_col" value="{{ $project->sort_col }}" id="sort_col" placeholder="Sort Col"
                                        required />
                                    @error('sort_col')
                                ...
                                <div class="card-action submitEditProjectBtn">
 ...
 --}}
    ...
    <script>
        $(document).ready(function() {
            // Handle the form submission for the project
            $('.submitEditProjectBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    type: 'POST',
                    // Adjust the route for the project form submission
                    url: '{{ route('update-project', $project->id) }}',
                    data: formData,
