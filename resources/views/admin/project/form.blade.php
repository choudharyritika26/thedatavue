                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('store-project') }}" method="post"
                                ...
                                <div class="card-action submitProjectBtn">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.submitProjectBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    url: '{{ route('store-project', isset($project) ? $project->id : null) }}',
                    data: formData,
