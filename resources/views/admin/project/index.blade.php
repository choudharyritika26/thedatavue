...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        {{-- <h1 style="margin-top: 20px">Project Management</h1> --}}
        <span>
            {{-- @if ($project->isEmpty()) --}}
                <a href="{{ route('add-project') }}"><button class="btn btn-primary">Add</button></a>
            {{-- @endif --}}
        </span>
    </div><!-- End Page Title -->
                                    ...
                                    <tr class="sortable-item" data-id="{{ $item->id }}">
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <form method="POST" action="{{ route('destroy-project', $item->id) }}"
    ...
    $(document).ready(function() {
        ...
        $("tbody").sortable({
            ...
            update: function(event, ui) {
                ...
                $.ajax({
                    url: "{{ route('update-project-order') }}",  // Define your route here   
                    method: "POST",
                    data: {
                        ids: sortedIDs,
