...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    ...
    <span style="">
      <a href="{{ route('about-index') }}"><button class="btn btn-primary">Back</button></a><br><br>
    </span>
    {{-- <span>
        <h1 style="margin-top:-30px; margin-left:800px;"><a href="{{route('about-index')}}">Back</a></h1>
    </span> --}}
    {{-- <nav>
        <ol class="breadcrumb">
  ...
  $(document).ready(function() {
    ...
    $('.submitAboutBtn').click(function(e) {
      ...
      $.ajax({
        ...
        url: '{{ route('
        store - about ', isset($about) ? $about->id : null) }}',
        data: formData,
