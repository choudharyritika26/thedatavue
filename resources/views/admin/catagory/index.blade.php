...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        {{-- <h1 style="margin-top: 20px">Portfolio Category Management</h1> --}}
        <div class="btn-group" role="group" aria-label="Basic example">
            <span style="">
                <a href="{{ route('add-catagory') }}"><button class="btn btn-primary">Add</button></a><br><br>
            </span>
        </div>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Portfolio Categories</h5>
                                    ...
                                    <tr class="sortable-item" data-id="{{ $item->id }}">
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center">
                                                <!-- Edit Button -->
                                                <a href="{{ route('edit-catagory', $item->id) }}"
                                                    class="btn btn-info btn-sm mx-2" title="Edit">
                                                    <i class="fa fa-edit" style="font-size:20px;"></i>
                                                </a>

                                                <form method="POST" action="{{ route('destroy-catagory', $item->id) }}"
    ...
    $(document).ready(function() {
        ...
        $("tbody").sortable({
            ...
            update: function(event, ui) {
                ...
                $.ajax({
                    url: "{{ route('update-catagory-order') }}",  // Define your route here   
                    method: "POST",
                    data: {
                        ids: sortedIDs,
