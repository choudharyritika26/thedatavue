                    ...
                    <div class="card p-4">
                        <div class="card-body">
                            ...
                            <form class="row g-3" action="{{ route('update-portfolio', $portfolio->id) }}" method="post"
                                ...
                                <div class="col-12">
                                    <label for="slider_image" class="form-label">Slider Images</label>
                                    ...
                                    <div class="image-preview mb-3" id="sliderImagePreview">
                                        @foreach ($imageFilenames as $index => $filename)
                                            <div class="slider-image-container" style="display: inline-block; position: relative; margin: 5px;">
                                                <img src="{{ asset('storage/' . $filename) }}" alt="" class="img-fluid slider-image"
                                                    style="width: 300px; height: 200px;" id="sliderImage-{{ $index }}">
                                                <input type="hidden" class="crop-data-x" name="cropDataX_{{ $index }}">
                                                <input type="hidden" class="crop-data-y" name="cropDataY_{{ $index }}">
                                                <input type="hidden" class="crop-data-width" name="cropDataWidth_{{ $index }}">
                                                <input type="hidden" class="crop-data-height" name="cropDataHeight_{{ $index }}">
                                                <button type="button" class="btn btn-danger btn-sm remove-image" style="position: absolute; top: 0; right: 0;">Remove</button>
                                            </div>
                                        @endforeach
                                    </div>
                                
                                    <input type="file" class="form-control" name="slider_image[]" multiple id="slider_image" accept="image/*" onchange="previewSliderImages(event)">
                                ...
                                <div class="card-action submitEditPortfoliosBtn">
                                    <button class="btn btn-success" href="{{ route('portfolio-index') }}">Submit</button>
