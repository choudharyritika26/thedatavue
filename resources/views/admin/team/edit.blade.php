                            ...
                            <form class="row g-3" action="{{ route('update-team',$team->id) }}" method="post"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('sort_col') is-invalid @enderror" type="text"
                                        name="sort_col" value="{{ $team->sort_col }}" id="sort_col" placeholder="Sort Col" required/>
                                    @error('sort_col')
                                ...
                                <div class="card-action submitEditTeamBtn">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.submitEditTeamBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
