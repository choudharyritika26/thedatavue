                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('store-achievement') }}" method="post"
                                ...
                                <div class="card-action submitAchievementBtn">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.submitAchievementBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    url: '{{ route('store-achievement', isset($achievement) ? $achievement->id : null) }}',
                    data: formData,
