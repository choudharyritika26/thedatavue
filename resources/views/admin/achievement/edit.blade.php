...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <span style="">
                <a href="{{ route('achievement-index') }}"><button class="btn btn-primary">Back</button></a><br><br>
            </span>
            {{-- <span>
                <h1 style="margin-top:-30px; margin-left:800px;"><a href="{{ route('achievement-index') }}">Back</a></h1>
            </span> --}}
            {{-- <nav>
        <ol class="breadcrumb">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('update-achievement', $achievement->id) }}" method="post"
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="heading"
                                        value="{{ $achievement->heading }}"id="heading">
                                </div>

                                <div class="form-group">
                                    <label for="comment">Description</label>
                                    <textarea class="form-control" id="comment" name="description" rows="3">{!! html_entity_decode($achievement->description) !!} </textarea>
                                </div>

                                {{-- <div class="col-12">
                                    <label for="image" class="form-label">Image</label>
                                    <img src="{{ asset('storage/' . $achievement->image) }}" alt="" class="img-fluid mb-3"
                                        style="width: 200px;height:150px;">
                                    <input type="file" class="form-control" name="image" value="{{ $achievement->image }}"
                                ...
                                <!-- <div class="mb-3">
                                    ...
                                    <input class="form-control @error('sort_col') is-invalid @enderror" type="text"
                                        name="sort_col" value="{{ $achievement->sort_col }}" id="sort_col" placeholder="Sort Col"
                                        required />
                                    @error('sort_col')
                                ...
                                <div class="card-action submitEditAchievementBtn">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            // Handle the form submission for the achievement
            $('.submitEditAchievementBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    type: 'POST',
                    // Adjust the route for the achievement form submission
                    url: '{{ route('update-achievement', $achievement->id) }}',
                    data: formData,
