...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            {{-- <span>
                <h1 style="margin-top:-30px; margin-left:800px;"><a href="{{ route('footer-copy-right-index') }}">Back</a></h1>
            </span> --}}
            <span style="">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit Footer Copy Right</h5>


                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('update-footer-copy-right', $footercopyright->id) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="comment" name="description" rows="3">{{ $footercopyright->description }} </textarea>
                                ...
                                <div class="card-action submitEditFooterCopyRightBtn">
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.submitEditFooterCopyRightBtn').click(function(e) {
                //alert('jijed');
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    url: '{{ route('update-footer-copy-right', $footercopyright->id) }}',
                    data: formData,
