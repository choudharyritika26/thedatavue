                                ...
                                <form class="row g-3" action="{{ route('update-slider', $slider->id) }}" method="post"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <img src="{{ asset('storage/' . $slider->image) }}" alt=""
                                            class="img-fluid mb-3" style="width:300px;height:200px;">
                                        <input type="file" class="form-control" name="image"
                                            value="{{ $slider->image }}" id="image" onchange="previewImage(event)">
                                    </div>
                                    ...
                                    {{-- <div class="col-12">
                                        ...
                                        <input class="form-control @error('sort_col') is-invalid @enderror" type="text"
                                            name="sort_col" value="{{ $slider->sort_col }}" id="sort_col" placeholder="Sort Col" required/>
                                        @error('sort_col')
