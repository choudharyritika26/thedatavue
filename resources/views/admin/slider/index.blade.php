...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <span>
                <h1 style="margin-top:-30px; margin-left:750px;"><a href="{{ route('add-slider') }}">Add Slider</a></h1>
            </span>
            {{-- <nav>
        <ol class="breadcrumb">
                                ...
                                <tbody>
                                    @foreach ($slider as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('edit-slider', $item->id) }}"> <i class="fa fa-edit"
                                                        style="font-size:30px"></i></a>
                                                <br>
                                                {{-- <a href="{{ route('delete-slider', $item->id) }}" 
                                    class="btn btn-danger btn-sm">Delete</a> --}}
                                                {{-- <a href="{{ route('destroy-slider', $item->id) }}"> <i
