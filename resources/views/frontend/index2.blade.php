            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                    <div class="faq-img RotateMoveRight rounded">
                        <img src="{{ asset('storage/' . $whychooseus->image) }}" class="img-fluid rounded w-100" alt="Image">
                    ...
                    <div class="col-sm-4">
                        <div class=" rounded p-4">
                            ...
                            <div class="d-flex align-items-center justify-content-center" style="margin-top: -20px;">
                                <h4> <span class="counter-value fs-1 text-danger fw-bold" data-toggle="counter-up">{{ $project->count }} </span></h2>
            ...
            <div class="row g-4 align-items-center">
                ...
                <div class="col-xl-8">
                    <div class="testimonial-carousel owl-carousel wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="testimonial-item bg-white rounded p-4 wow fadeInUp" data-wow-delay="0.3s"  style="height:350px">
                            <div class="d-flex">
