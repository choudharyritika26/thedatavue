        ...
        <div class="row g-4">
            <div class="col-lg-6 col-md-6 ">
                <div class="footer-item d-flex flex-column">
                    <div class="footer-item">
                        ...
                        <p style="color:blue font-family: Bell MT!important;">TheDataVue Technologies is a
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-item d-flex flex-column">
                    ...
                    <a href="#" style="color: black"><i class="fas fa-angle-right me-2" style="color: black"></i>
                        Home</a>
                    <a href="#" style="color: black"><i class="fas fa-angle-right me-2" style="color: black"></i>
                        Services</a>
                    <a href="#" style="color: black"><i class="fas fa-angle-right me-2" style="color: black"></i>
